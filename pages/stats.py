...
st.write(
    "Here you can view descriptive statistics for all my datasets as well as download them in .csv format. Also listed below is my jupyter notebook for this project, all the data has been cleaned up as depicted in jupyter")
